...
<body id="page-top">
  ...
  <section class="page-section" id="contact">
    ...
    <div class="container">
      ...
      <h2 class="page-section-heading text-center text-uppercase text-secondary mb-0">Find the TA</h2>
      ...
      <div class="row">
        <div class="col-lg-8 mx-auto">
          ...
          <form name="sentMessage" method="POST" action="datafind.php" id="contactForm" novalidate="novalidate">
